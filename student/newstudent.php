    ...
    <?php include 'C:\xampp\htdocs\school_Management\side_navigation\top_navigation.php';?>    
        ...
        <div class="second_nav">
            <div class="heading_con">
                <span class="heading"><a href=""+<?php echo $_SERVER['PHP_SELF']; ?> class="second_heading">NEW STUDENT</a></span><span class="path">Home / <a href="students.php">Student</a>/ <a href=""+<?php echo $_SERVER['PHP_SELF']; ?>>New Student</a></span>
            </div>
        </div>
