    ...
    <?php include 'C:\xampp\htdocs\school_Management\side_navigation\top_navigation.php';?> 
        ...
        <div class="second_nav">
            <div class="heading_con">
                <span class="heading"><a href=""+<?php echo $_SERVER['PHP_SELF']; ?> class="second_heading">TEACHER DETAILS</a></span><span class="path">Home / <a href="teachers.php">Teacher</a>/ <a href=""+<?php echo $_SERVER['PHP_SELF']; ?>>Edit</a></span>
            </div>
        </div>
        ...
        <div class="data_upload_msz">
            <div class="msz_container">
                ...
                <div class="msz_flow_s">
                    ...
                    <div class="processing_s">Data edited Succesfully.</div>
