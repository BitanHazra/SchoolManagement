    ...
    <?php include 'C:\xampp\htdocs\school_Management\side_navigation\top_navigation.php';?>
        <div class="second_nav">
            <div class="heading_con">
                <span class="heading"><a href=""+<?php echo $_SERVER['PHP_SELF']; ?> class="second_heading">TEACHER DETAILS</a></span><span class="path">Home / <a href="teachers.php">Teacher</a>/ <a href=""+<?php echo $_SERVER['PHP_SELF']; ?>>New Teacher</a></span>
            </div>
        </div>
                ...
                <div class="new_teacher_con">
                    ...
                    <div class="personal_detail">
                        <div class="first_column">
                            <p>Profile Image</p>
                            <div class="image_con">
                            <span><input type='file' accept="image/*" id="file_input"><img src="" class="img_upload" alt="Profile Image"></span>
                        ...
                        <div class="second_column">
                            ...
                            <input type="text" name="employee_id" required id="employee_id">
                        </div>
                    ...
                    <div class="buttons">
                        <input type="button" value="Add" id="addNewbtn">
        ...
        <div class="data_upload_msz">
            <div class="msz_container">
                <div class="msz_flow">
                    ...
                    <span><button id="upload_msz_close_p">Close</button></span>
                ...
                <div class="msz_flow_s">
                    ...
                    <div class="processing_s">Data added Succesfully.</div>
        ...
        <script src="newEmpscript.js"></script>
    </body>
</html>