$(document).ready(function(){
    ...
    function fetchparentData(empid){
        $.ajax({
            ...
            success:function(data){
                ...
                var emp_name = emp_data['parent_name'];
    ...
    fetchparentData(empid);
    $('#canclebtn').on('click',function(){
        window.close();
        window.location.href='/school_Management/parents/parents.php';
    });
    ...
    function deleteparentData(empid){
        $.ajax({
            url:'dataUploadTable.php',
            type:'POST',
