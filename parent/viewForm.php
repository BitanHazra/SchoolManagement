    ...
    <body>
        ...
        <div class="second_nav">
            <div class="heading_con">
                <span class="heading"><a href=""+<?php echo $_SERVER['PHP_SELF']; ?> class="second_heading">parent DETAILS</a></span><span class="path">Home / <a href="parent.php">parent</a>/ <a href=""+<?php echo $_SERVER['PHP_SELF']; ?>>view</a></span>
            </div>
        </div>
